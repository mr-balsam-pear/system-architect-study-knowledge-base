...
assert.match(overlayCss, /\.podcast-mini-player\s*\{[^}]*width:\s*min\(36rem,/s);
assert.match(overlayCss, /\.podcast-mini-player strong\s*\{[^}]*font-size:\s*var\(--text-sm\)/s);
assert.match(overlayCss, /\.podcast-mini-player span\s*\{[^}]*font-size:\s*var\(--text-xs\)/s);
assert.match(overlayCss, /@media\s*\(max-width:\s*52rem\)/);
assert.match(overlayCss, /\.podcast-mini-player a\s*\{[^}]*background:\s*transparent/s);
